...
namespace SpecflowTests.AcceptanceTest
{
    ...
    public class SpecFlowFeature1Steps : Utils.Start
    {
        ...
        public void WhenIAddANewLanguage()
        {
            ...
            Driver.driver.FindElement(By.XPath("//*[@id='language']/div/div[2]/div/table/thead/tr/th[3]/div")).Click();

            //Add Language
            Driver.driver.FindElement(By.XPath("//*[@id='language']/div/div[2]/div/div/div[1]/input")).SendKeys("English");

            //Click on Language Level
            Driver.driver.FindElement(By.XPath("//*[@id='language']/div/div[2]/div/div/div[2]/select")).Click();
